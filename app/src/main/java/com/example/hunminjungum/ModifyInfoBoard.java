...
public class ModifyInfoBoard extends Activity {
    int postnum1;
    String session_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ModifyInfoBoardRequest modifyInfoBoardRequest = new ModifyInfoBoardRequest(postnum1, responseListener);
        RequestQueue queue = Volley.newRequestQueue(ModifyInfoBoard.this);
        queue.add(modifyInfoBoardRequest);
            ...
            public void onClick(View view){
                ...
                DialogInterface.OnClickListener yesButtonClickListener = new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            public void onResponse(String response) {
                                try{
                                    ...
                                    if(success){
                                        ...
                                        AlertDialog.Builder builder = new AlertDialog.Builder(ModifyInfoBoard.this);
                        ...
                        ModifyInfoBoardOkRequest modifyInfoBoardOkRequest = new ModifyInfoBoardOkRequest(sTitle, sContent, postnum1,responseListener);
                        RequestQueue queue = Volley.newRequestQueue(ModifyInfoBoard.this);
                        queue.add(modifyInfoBoardOkRequest);
                    }
                };
                AlertDialog.Builder builder = new AlertDialog.Builder(ModifyInfoBoard.this);
