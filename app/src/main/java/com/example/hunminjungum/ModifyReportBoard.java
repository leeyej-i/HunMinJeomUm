...
public class ModifyReportBoard extends Activity {
    int postnum1;
    String session_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ModifyReportBoardRequest modifyReportBoardRequestt = new ModifyReportBoardRequest(postnum1, responseListener);
        RequestQueue queue = Volley.newRequestQueue(ModifyReportBoard.this);
        queue.add(modifyReportBoardRequestt);
            ...
            public void onClick(View view){
                ...
                DialogInterface.OnClickListener yesButtonClickListener = new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            public void onResponse(String response) {
                                try{
                                    ...
                                    if(success){
                                        ...
                                        AlertDialog.Builder builder = new AlertDialog.Builder(ModifyReportBoard.this);
                        ...
                        ModifyReportBoardOkRequest modifyReportBoardOkRequest = new ModifyReportBoardOkRequest(sTitle, sContent, postnum1,responseListener);
                        RequestQueue queue = Volley.newRequestQueue(ModifyReportBoard.this);
                        queue.add(modifyReportBoardOkRequest);
                    }
                };
                AlertDialog.Builder builder = new AlertDialog.Builder(ModifyReportBoard.this);
